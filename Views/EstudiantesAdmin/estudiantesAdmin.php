...
<?php require('./Views/Modals/modalEstudiantes.php');?>
<div class="container container-rol">
  <div>
    <h3>Estudiantes | Instituto Inmac</h3>
    <!-- Boton Modal Nuevo -->
<button class="btn btn-secondary btn-rol text-white mb-5" type="button"  data-bs-toggle="modal" data-bs-target="#modalFormEstudiante" onclick="openModalEstudiante();">
