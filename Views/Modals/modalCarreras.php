 <!-- Modal -->
 <div class="modal fade" id="modalFormCarrera" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content">
       <div class="modal-header headerRegister" id="modalCarrera">
         <h1 class="modal-title fs-3" id="titleModal">Nueva Carrera</h1>
       ...
       <div class="modal-body p-5">
         <form name="formCarrera" id="formCarrera">
           ...
           <div class="form-group mb-5">
             <label for="txtDuracion" class="mb-4">Duracion</label>
             <input type="number" placeholder="duración en años" class="form-control shadow" id="txtDuracion" name="txtDuracion">
           </div>
