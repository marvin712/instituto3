...
<?php require('./Views/Modals/modalGrados.php');?>
<div class="container container-rol">
  <div>
    <h3>Grados | Instituto Inmac</h3>
    <!-- Boton Modal Nuevo -->
<button class="btn btn-secondary btn-rol text-white mb-5" type="button"  data-bs-toggle="modal" data-bs-target="#modalFormGrado" onclick="openModalGrado();">
