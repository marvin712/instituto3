...
<?php require_once('./Views/Profesores/profesores_header.php');?>
    ...
    <div class="container-fluid container-cards">
      <!-- Tittle -->
      <h1 class="h2 pb-4">Dashboard | Profesores</h1>
      <div class="row mb-5">
              ...
              <div class="row">
                <div class="col d-flex justify-content-between">
                  <div>
                    ...
                    <!-- Subtitle -->
                    <h2 class="mb-0">
                    <?= $_SESSION['userCurso']['CantidadCursos']; ?>
                    </h2>
                    <!-- Comment -->
              ...
              <div class="row">
                <div class="col d-flex justify-content-between">
                  <div>
                    <!-- Title -->
                    <h5 class="d-flex align-items-center text-uppercase text-muted fw-semibold mb-2">
                      <span class="circle2"></span><span class="legend-circle-sm bg-success"></span>Avisos
                    </h5>
                    <!-- Subtitle -->
                    <h2 class="mb-0">
                      7
              ...
              <div class="row">
                <div class="col d-flex justify-content-between">
                  <div>
                    <!-- Title -->
                    <h5 class="d-flex align-items-center text-uppercase text-muted fw-semibold mb-2">
                      <span class="circle3"></span><span class="legend-circle-sm bg-success"></span>Estudiantes
                    </h5>
                    <!-- Subtitle -->
                    <h2 class="mb-0">
                      34
              ...
              <div class="row">
                <div class="col d-flex justify-content-between">
                  <div>
                    <!-- Title -->
                    <h5 class="d-flex align-items-center text-uppercase text-muted fw-semibold mb-2">
                      <span class="circle4"></span><span class=""></span>Cursos
                    </h5>
                    <!-- Subtitle -->
                    <h2 class="mb-0">
                      3
      ...
      <!-- Graficos -->
      <!-- <h2>Gráficos</h2> -->
      <h2>Bienvenido <?= $_SESSION['userData']['nombreProfesor']; ?> <?= $_SESSION['userData']['apellidoProfesor']; ?></h2>
